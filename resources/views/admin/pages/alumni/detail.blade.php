        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-9 mt-3 mt-lg-0">
                    ...
                    <div class="container">
                        @include('admin.pages.alumni.partials.alumni-detail')
                    </div>
                    ...
                    <div class="container">
                        @include('admin.pages.alumni.partials.alumni-kontak')
                    </div>
                    <div class="row align-items-center mt-3 mb-0">
                        <div class="col-lg-12">
                    ...
                    <div class="container">
                        @include('admin.pages.alumni.partials.alumni-akademik')
                    </div>
                    <div class="row align-items-center mt-3 mb-0">
                        <div class="col-lg-12">
                    ...
                    <div class="container">
                        @include('admin.pages.alumni.partials.alumni-keluarga')
                    </div>
                </div>
            </div>
        </div>
