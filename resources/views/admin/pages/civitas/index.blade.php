@extends('admin.layouts.app', ['title' => 'Data GTK'])
...
@section('content')
    ...
    @include('admin.pages.civitas.component.add-modal')
    @include('admin.pages.civitas.component.edit-modal')
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '#editItem', function() {
                ...
                $.get("{{ route('gtk.index') }}" + '/' + civitas_id + '/edit', function(data) {
            ...
            $('body').on('click', '.deleteBtn', function(e) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        data: formData,
                        url: "{{ route('gtk.index') }}" + '/' + company_id,
                        contentType: false,
                        processData: false,
                        type: "POST",
