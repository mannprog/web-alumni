...
@section('content')
    ...
    @include('admin.pages.company.component.add-modal')
    @include('admin.pages.company.component.edit-modal')
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '#editItem', function() {
                ...
                $.get("{{ route('perusahaan.index') }}" + '/' + company_id + '/edit', function(data) {
            ...
            $('body').on('click', '.deleteBtn', function(e) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        data: formData,
                        url: "{{ route('perusahaan.index') }}" + '/' + company_id,
                        contentType: false,
                        processData: false,
                        type: "POST",
