@extends('admin.layouts.app', ['title' => 'Data Perusahaan'])
...
@section('content')
    ...
    @include('admin.pages.perusahaan.component.add-modal')
    @include('admin.pages.perusahaan.component.edit-modal')
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '#editItem', function() {
                ...
                $.get("{{ route('perusahaan.index') }}" + '/' + perusahaan_id + '/edit', function(data) {
            ...
            $('#updateBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "{{ route('perusahaan.index') }}" + '/' + perusahaan_id,
                    contentType: false,
                    processData: false,
                    type: "POST",
                    success: function(data) {
