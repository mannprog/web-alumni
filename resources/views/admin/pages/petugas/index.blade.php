@extends('admin.layouts.app', ['title' => 'Data Petugas'])
...
@section('content')
    ...
    @include('admin.pages.petugas.component.add-modal')
    @include('admin.pages.petugas.component.edit-modal')
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#updateBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "{{ route('petugas.index') }}" + '/' + petugas_id,
                    contentType: false,
                    processData: false,
                    type: "POST",
                    success: function(data) {
