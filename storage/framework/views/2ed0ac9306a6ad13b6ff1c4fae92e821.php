    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="<?php echo e(route('lamaran.accept', $lamar->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="rejModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
                <form action="<?php echo e(route('lamaran.reject', $lamar->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\web-alumni\resources\views/admin/pages/loker/component/accOrRej.blade.php ENDPATH**/ ?>