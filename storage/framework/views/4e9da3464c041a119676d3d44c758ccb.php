<form id="deleteDoc" method="post">
    ...
    <a href="<?php echo e(route('gtk.show', $row->id)); ?>" class="btn btn-sm mb-0 btn-primary"><i class="fas fa-eye"></i></a>
...
<?php /**PATH C:\laragon\www\web-alumni\resources\views/admin/pages/civitas/component/action.blade.php ENDPATH**/ ?>