    ...
    <div class="row">
        <?php $__currentLoopData = $alumni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $al): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-4 mb-4">
                <a href="<?php echo e(route('alumnus.detail', $al->username)); ?>" class="card-link text-dark">
...
<?php echo $__env->make('notadmin.layouts.app', ['title' => 'Alumni'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\web-alumni\resources\views/notadmin/pages/alumni/index.blade.php ENDPATH**/ ?>