    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="updateForm" name="updateForm" method="post">
                ...
                <input type="hidden" name="edit_roles" id="edit_roles">
                <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin|kepalasekolah|petugas')): ?>
                    <?php echo $__env->make('admin.pages.profile.component.partials.edit-petugas', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>

                <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'perusahaan')): ?>
                    <?php echo $__env->make('admin.pages.profile.component.partials.edit-perusahaan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
...
<?php /**PATH C:\laragon\www\web-alumni\resources\views/notadmin/pages/profile/component/edit-modal.blade.php ENDPATH**/ ?>