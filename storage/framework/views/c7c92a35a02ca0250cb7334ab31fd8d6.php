<?php $__env->startSection('content'); ?>
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin|petugas')): ?>
            <button id="createperusahaan" class="btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i>
                Tambah</button>
        <?php endif; ?>
    </div>
    ...
    <?php echo $__env->make('admin.pages.perusahaan.component.add-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.pages.perusahaan.component.edit-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('custom-scripts'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createperusahaan').click(function() {
                setTimeout(function() {
                    $('#name').focus();
                }, 500);
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('#itemForm').trigger("reset");
                        $('#modal-md').modal('hide');
                        $('#perusahaan-table').DataTable().draw();
                        Swal.fire({
                            icon: 'success',
                            title: 'Success',
                            text: data.message,
            ...
            $('body').on('click', '#editItem', function() {
                ...
                $.get("<?php echo e(route('perusahaan.index')); ?>" + '/' + perusahaan_id + '/edit', function(data) {
                    $('#modal-edit').modal('show');
                    setTimeout(function() {
                        $('#name').focus();
                    }, 500);
                    $('.modal-title').html("Ubah Data Perusahaan");
            ...
            $('#updateBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "<?php echo e(route('perusahaan.index')); ?>" + '/' + perusahaan_id,
                    contentType: false,
                    processData: false,
                    type: "POST",
                    success: function(data) {
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Data Perusahaan'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\web-alumni\resources\views/admin/pages/perusahaan/index.blade.php ENDPATH**/ ?>