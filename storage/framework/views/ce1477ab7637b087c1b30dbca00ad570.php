    ...
    <div class="row">
        <?php $__currentLoopData = $lowongan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-4 mb-4">
                <a href="<?php echo e(route('lowongan.detail', $loker->slug)); ?>" class="card-link text-dark">
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Lowongan Kerja'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\web-alumni\resources\views/admin/pages/general/lowongan/index.blade.php ENDPATH**/ ?>