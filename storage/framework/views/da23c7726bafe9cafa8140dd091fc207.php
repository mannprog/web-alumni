...
<?php $__env->startSection('content'); ?>
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?php echo e(route('export.perusahaan')); ?>" target="_blank" class="btn btn-sm btn-primary shadow-sm"><i
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Laporan | Perusahaan'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\web-alumni\resources\views/admin/pages/laporan/perusahaan.blade.php ENDPATH**/ ?>