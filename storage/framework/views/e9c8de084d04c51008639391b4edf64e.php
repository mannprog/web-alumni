<?php $__env->startSection('content'); ?>
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <button id="createLoker" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
    ...
    <?php echo $__env->make('admin.pages.loker.component.add-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createLoker').click(function() {
                ...
                $('.modal-title').html("Tambah Lowongan Kerja");
                $('#modal-md').modal('show');
            });
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "<?php echo e(route('loker.store')); ?>",
                    contentType: false,
                    processData: false,
                    type: "POST",
            ...
            $('body').on('click', '.deleteBtn', function(e) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        data: formData,
                        url: "<?php echo e(route('loker.index')); ?>" + '/' + loker_id,
                        contentType: false,
                        processData: false,
                        type: "POST",
                        success: function(data) {
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Lowongan Kerja'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\web-alumni\resources\views/admin/pages/loker/index.blade.php ENDPATH**/ ?>