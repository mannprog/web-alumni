<?php $__env->startSection('content'); ?>
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin|petugas')): ?>
            <button id="createkategori" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
    ...
    <?php echo $__env->make('admin.pages.kategori.component.addOrEdit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '#editItem', function() {
                ...
                $.get("<?php echo e(route('kategori.index')); ?>" + '/' + kategori_id + '/edit', function(data) {
                    $('#modal-md').modal('show');
                    setTimeout(function() {
                        $('#nama').focus();
                    }, 500);
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "<?php echo e(route('kategori.store')); ?>",
                    contentType: false,
                    processData: false,
                    type: "POST",
            ...
            $('body').on('click', '.deleteBtn', function(e) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        data: formData,
                        url: "<?php echo e(route('kategori.index')); ?>" + '/' + kategori_id,
                        contentType: false,
                        processData: false,
                        type: "POST",
                        success: function(data) {
                        ...
                        error: function(data) {
                            ...
                            toastr.error('Tidak bisa hapus data karena sedang digunakan')
                        }
                    });
                }
            });
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Kategori'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\web-alumni\resources\views/admin/pages/kategori/index.blade.php ENDPATH**/ ?>