            ...
            <tbody>
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td style="text-align: center;"><?php echo e(\Carbon\Carbon::parse($row->tanggal_mulai)->format('d M Y')); ?>

                        </td>
                        <td style="text-align: center;"><?php echo e(\Carbon\Carbon::parse($row->tanggal_akhir)->format('d M Y')); ?>
...
<?php /**PATH C:\laragon\www\web-alumni\resources\views/admin/pages/laporan/pdf/lowongan.blade.php ENDPATH**/ ?>